import { priceChart } from "./modules/chart.js";
    ...
    <section class="summary-grid" aria-label="观察清单摘要">
      ...
      <article class="metric-card is-amber">
        <div class="metric-topline">
          ...
          <span class="metric-icon">${icon("radar")}</span>
        </div>
      ...
      <article class="metric-card">
        <div class="metric-topline">
          ...
          <span class="metric-icon">${icon("database")}</span>
        </div>
              ...
              <table class="watchlist-table">
                <thead>
                  <tr>
                    ...
                    ${sortableHeader("现价", "price", true)}
                    ${sortableHeader("日涨跌", "change", true)}
                    ${sortableHeader("理想价", "preferred", true)}
                    ${sortableHeader("距理想价", "distance", true)}
                    ${sortableHeader("股息回购率", "yield", true)}
                    <th>估值状态</th>
                    <th>提醒状态</th>
                    ${sortableHeader("行情更新", "updated")}
                  </tr>
                </thead>
